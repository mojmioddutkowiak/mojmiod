  ...
  <section class="footer-block" id="block_various_links_footer">
    ...
    <ul class="toggle-footer">
      ...
      <li id="header_link_blog">
        <a {if $page_name =='module-smartblog-category'}class="active"{/if} href="{$link->getPageLink('smartblog', true)|escape:'html'}" title="{l s='smartblog' mod='blockpermanentlinks'}">{l s='Blog' mod='blockcms'}</a>
      </li>
    </ul>
    {$footer_text}
  </section>
