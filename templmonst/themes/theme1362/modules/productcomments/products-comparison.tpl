  ...
  {foreach from=$list_ids_product item=id_product}
    <td class="{$classname} comparison_infos product-{$id_product}">
      {if isset($product_comments[$id_product]) && $product_comments[$id_product]}
        <a class="btn btn-default btn-sm icon-right" href="#" data-id-product-comment="{$id_product|intval}" data-rel="#comments_{$id_product|intval}" title="{l s='View comments' mod='productcomments'}">
          <span>
