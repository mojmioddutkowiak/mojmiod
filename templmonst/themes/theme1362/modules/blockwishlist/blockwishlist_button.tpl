{if isset($wishlists) && count($wishlists) > 1}
  <div class="wishlist">
	...
	<a class="wishlist_button_list" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Wishlist' mod='blockwishlist'}" data-placement="top"><span>{l s='Add to wishlist' mod='blockwishlist'}</span></a>
