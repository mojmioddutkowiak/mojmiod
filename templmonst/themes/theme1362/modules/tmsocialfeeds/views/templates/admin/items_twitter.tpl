	...
	<form method="post" action="" enctype="multipart/form-data" class="item-form defaultForm form-horizontal">
        <div class="well">
            ...
            <div class="item-field form-group">
                ...
                <div class="col-lg-3">
                	<select class="select" name="item_theme">
                    	<option value="dark"{if $hItem.item_theme=="dark"} selected="selected"{/if}>{l s='dark' mod='tmsocialfeeds'}</option>
                        <option value="light"{if $hItem.item_theme=="light"} selected="selected"{/if}>{l s='light' mod='tmsocialfeeds'}</option>
                    </select>
                </div>
            </div>
            <div class="item-field form-group">
                ...
                <div class="col-lg-3">
                    <input type="text" name="sort_order" value="{if $hItem.item_order}{$hItem.item_order|escape:'html':'UTF-8'}{/if}">
                </div>
            </div>
            <div class="item-field form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer" id="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer_on" value="1" {if $hItem.item_footer} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeeds'}
                        </label>
                        <input type="radio" name="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer" id="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer_off" value="0" {if !$hItem.item_footer} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_footer_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeeds'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background" id="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background_on" value="1" {if $hItem.item_background} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='tmsocialfeeds'}
                        </label>
                        <input type="radio" name="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background" id="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background_off" value="0" {if !$hItem.item_background} checked="checked"{/if}>
                        <label for="{$hItem.item_type|escape:'html':'UTF-8'}_{$hook|escape:'html':'UTF-8'}_background_off" class="radioCheck">
                            <i class="color_danger"></i> {l s='No' mod='tmsocialfeeds'}
                        </label>
                        <a class="slide-button btn"></a>
                    </span>
