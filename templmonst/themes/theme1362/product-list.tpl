{if isset($products) && $products}
  ...
  {if $page_name !='category'}
    {if ($hide_left_column || $hide_right_column) && ($hide_left_column !='true' || $hide_right_column !='true')}   {* left or right column *}
      ...
      {assign var='nbItemsLine' value=3}
  ...
  <!-- Products list -->
  <ul{if isset($id) && $id} id="{$id}"{/if} class="{if $page_name !='index'}no-index{/if} product_list grid row{if isset($class) && $class} {$class}{/if}">
    {foreach from=$products item=product name=products}
      ...
      <li class="{if isset($nbItemsLine) && $smarty.foreach.products.iteration%$nbItemsLine == 0}border-line{/if} ajax_block_product col-xs-12 col-sm-{12/$nbItemsPerLineTablet} col-md-{12/$nbItemsPerLine}{if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} last-in-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} first-in-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0} last-item-of-tablet-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1} first-item-of-tablet-line{/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 0} last-item-of-mobile-line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 1} first-item-of-mobile-line{/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloMobile)} last-mobile-line{/if}">
        <div class="product-container" itemscope itemtype="https://schema.org/Product">
          ...
          <div class="right-block">
            ...
            <div class="buttons {if $product.customizable == true}customizable{/if}">
