...
{if !$opc}
  <p class="cart_navigation clearfix">
    ...
    {if $back}
      <a href="{$link->getPageLink('order', true, NULL, "back={$back}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-default btn-md icon-left">
        <span>{l s='Continue Shopping'}</span>
      </a>
    {else}
      <a href="{$link->getPageLink('order', true, NULL)|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-default btn-md icon-left">
        <span>{l s='Continue Shopping'}</span>
      </a>
    {/if}
