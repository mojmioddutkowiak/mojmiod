...
{if $errors|@count == 0}
  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <div class="primary_block row">
      ...
      {/if}
        <!-- left infos-->
        <div class="pb-left-column{if $columns == 2} col-xs-12 col-md-7 col-lg-6{elseif $columns == 3} col-xs-12{else} col-sm-6 col-md-6 col-lg-8{/if}">
          <!-- product img-->
        ...
        <!-- center infos -->
        <div class="pb-right-column {if $columns == 2}col-xs-12 col-md-5 col-lg-6{elseif $columns == 3}col-xs-12 {elseif $content_only} col-xs-6{else}col-sm-6 col-md-6 col-lg-4{/if}">
