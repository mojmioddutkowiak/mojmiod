...
*}
{capture name=path}<a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" title="{l s='Manage my account' mod='tmsociallogin'}" rel="nofollow">{l s='My account' mod='tmsociallogin'}</a><span class="navigation-pipe">{$navigationPipe}</span>{l s='VK registration' mod='tmsociallogin'}{/capture}
{include file="$tpl_dir./errors.tpl"}
<form action="{$link->getModuleLink('tmsociallogin', 'vkregistration', array(), true)}" method="post" class="box">
	<div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <label class="radio-inline">
                    <input type="radio" value="2" name="gender" {if $gender == 'male' || $gender == 2}checked{/if} />{l s='Male' mod='tmsociallogin'}
                </label>
                <label class="radio-inline">
                    <input type="radio" value="1" name="gender" {if $gender == 'famale' || $gender == 1}checked{/if} />{l s='Famale' mod='tmsociallogin'}
                </label>
            </div>
            <div class="form-group">
