...
<div class="soc-settings-block {$hook|escape:'html':'UTF-8'}">
	<form method="post" action="" enctype="multipart/form-data" class="item-form defaultForm form-horizontal">
        <div class="well">
            ...
            <div class="item-field form-group">
                <label class="control-label col-lg-3">{l s='Widget column width' mod='tmsocialfeeds'}</label>
                <div class="col-lg-3">
                    <input type="text" name="item_col_width" value="{if $hItem.item_col_width}{$hItem.item_col_width|escape:'html':'UTF-8'}{/if}">
                </div>
            </div>
