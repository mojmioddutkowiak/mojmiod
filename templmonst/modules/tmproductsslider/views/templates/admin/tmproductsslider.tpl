...
<div class="panel">
	<h3>{l s='TemplateMonster Products Slides' mod='tmproductsslider'}</h3>
	<div class="clearfix">
                        ...
                        {if $item.id_product}
                        	<li id="item-{$item.id_product|escape:'htmlall':'UTF-8'}" class="item">
                                <form method="post" action="" enctype="multipart/form-data" class="defaultForm form-horizontal clearfix">
                                	...
                                	<span class="item_name">{$item.name|escape:'htmlall':'UTF-8'|truncate:45} <small>({l s='product ID' mod='tmproductsslider'} {$item.id_product|escape:'htmlall':'UTF-8'})</small></span>
    ...
    <div class="panel">
        ...
        <div class="panel-footer">
        	<button id="module_form_submit_btn" class="btn btn-default pull-right" name="submitSlider" value="1" type="submit">
            	<i class="process-icon-save"></i>{l s='Save' mod='tmproductsslider'}
            </button>
        </div>
    </div>
</form>