...
$sql[] = 'DROP TABLE `'._DB_PREFIX_.'tmmegamenu_video`';

$sql[] = 'DROP TABLE `'._DB_PREFIX_.'tmmegamenu_video_lang`';

$sql[] = 'DROP TABLE `'._DB_PREFIX_.'tmmegamenu_map`';

$sql[] = 'DROP TABLE `'._DB_PREFIX_.'tmmegamenu_map_lang`';
