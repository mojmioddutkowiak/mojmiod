...
<form method="post" action="" enctype="multipart/form-data" class="defaultForm form-horizontal">
	<div class="panel tmmegamenu">
        ...
        <div class="form-wrapper">
            ...
            <div class="form-group tmmegamenu_url_text">
            	...
            	<div class="col-lg-2">
                    ...
                    {else}
                    	{assign var='active' value=''}
                    {/if}
                	<input name="tab_url_custom" value="{if isset($item) && $item && $item.is_custom_url}{$item.url|escape:'htmlall':'UTF-8'}{/if}" type="text" placeholder="{l s='Custom Url' mod='tmmegamenu'}" autocomplete="off" style="display:none;" />
            ...
            <div class="mega_menu">
            	{if !isset($item)}<p class="alert alert-info text-left">{l s='Auto save will be available after item\'s first saving.' mod='tmmegamenu'}</p>{/if}
        ...
        <div class="panel-footer">
        	<button type="submit" name="updateItem" class="button-new-item-save btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save' mod='tmmegamenu'}</button>
          	<button type="submit" name="updateItemStay" class="button-new-item-save-stay btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save & Stay' mod='tmmegamenu'}</button>
            <button type="button" class="btn pull-right btn-primary" data-toggle="modal" data-target="#myModal"><i class="process-icon-edit"></i> {l s='Edit styles' mod='tmmegamenu'}</button>
