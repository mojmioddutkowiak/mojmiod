...
$(document).ready(function(){
  ...
  $('[name=HeaderSubmitLogin]').live('click', function (e) {
    e.preventDefault();
    submitLoginFunction($(this).closest('.login-content'));
  });
  $('.header-login-content .create-account-content button[type=submit]').live('click', function(e){
    e.preventDefault();
    submitCreate($(this).closest('.create-account-content'));
  });
  $('.forgot-password-content [type="submit"]').live('click', function(e){
    e.preventDefault();
  ...
  $('[name=HeaderSubmitLogin]').on('click', function (e) {
    e.preventDefault();
    submitLoginFunction($(this).closest('.login-content'));
  });
  $('.header-login-content .create-account-content button[type=submit]').on('click', function(e){
    e.preventDefault();
    submitCreate($(this).closest('.create-account-content'));
  });
  $('.forgot-password-content [type="submit"]').on('click', function(e){
    e.preventDefault();
    submitRetrieve($(this).closest('.forgot-password-content'));
  });
  if (TMHEADERACCOUNT_DISPLAY_STYLE == 'twocolumns') {
  ...
  if (!parseInt(TMHEADERACCOUNT_USE_REDIRECT)) {
    $('.header-login-content a.create').live('click', function (e) {
      e.preventDefault();
    ...
    $('.header-login-content a.signin').live('click', function (e) {
      e.preventDefault();
    ...
    $('.header-login-content a.forgot-password').live('click', function (e) {
      e.preventDefault();
      $(this).closest('.header-login-content').find('.login-content').addClass('hidden');
    ...
    $('.header-login-content a.create').on('click', function (e) {
      e.preventDefault();
      $(this).closest('.header-login-content').find('.login-content').addClass('hidden');
      $(this).closest('.header-login-content').find('.create-account-content').removeClass('hidden');
      if (typeof bindUniform !=='undefined') {
    ...
    $('.header-login-content a.signin').on('click', function (e) {
      e.preventDefault();
      $(this).closest('.header-login-content').find('.login-content').removeClass('hidden');
      $(this).closest('.header-login-content').find('.create-account-content').addClass('hidden');
      $(this).closest('.header-login-content').find('.forgot-password-content').addClass('hidden');
    });
    $('.header-login-content a.forgot-password').on('click', function (e) {
      e.preventDefault();
      $(this).closest('.header-login-content').find('.login-content').addClass('hidden');
      $(this).closest('.header-login-content').find('.forgot-password-content').removeClass('hidden');
    });
